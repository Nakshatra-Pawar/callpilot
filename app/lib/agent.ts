 ...
 * Jordan", "always sign off as Jordan") makes the agent sycophantic
...
export function buildRepContextBlock(rep: Rep | null): string {
  ...
  return [
    `The rep using this copilot is ${rep.name}. This is their personal CallPilot — you are assisting ${rep.name} on every call.`,
...
/**
 * Compose the full system prompt for the CallPilot agent. The customer
...
export function buildAgentInstructions(
  ...
  return [
    "You are CallPilot, a sales copilot for a sales rep.",
