...
import { ConsentDialog } from "@/components/callpilot/consent-dialog";
import { PostCallSummaryCard } from "@/components/callpilot/post-call-summary-card";
import { TranscriptLine } from "@/components/callpilot/transcript-line";
import { TopRail } from "@/components/callpilot/top-rail";
import { LedgerPanel } from "@/components/callpilot/ledger-panel";
import { InlineToolCallRow } from "@/components/callpilot/inline-tool-call-row";
import { PreCallBriefing } from "@/components/callpilot/pre-call-briefing";
import { CallLogView } from "@/components/callpilot/call-log-view";
import { RepOnboarding } from "@/components/callpilot/rep-onboarding";
import { PreAuthShell } from "@/components/callpilot/pre-auth-shell";
import { OrbCallMeta } from "@/components/callpilot/orb-call-meta";
 ...
 * effects live in child components and hooks — see `components/callpilot/`
 * and `app/hooks/`.
 */
export default function Home() {
  ...
  async function connect() {
    try {
      ...
      // turn closed early. Acceptable for CallPilot's UX.
      try {
  ...
  //   1. Product narrative: CallPilot is "your personal agent", so it
      ...
      <main className="mx-auto flex w-full max-w-[1400px] flex-1 flex-col lg:min-h-0 lg:flex-row">
        ...
        >
          {stageView === "log" ? (
            ...
            <div className="callpilot-stagger-hero flex flex-col gap-6 lg:h-full lg:overflow-y-auto lg:pr-1">
            ...
            <>
              ...
              <div className="flex flex-col gap-8 md:flex-row md:gap-12 lg:gap-16">
                <div className="flex flex-col items-center justify-center gap-4 md:w-[320px] md:shrink-0">
                  <div className="callpilot-stagger-orb flex flex-col items-center gap-2">
                    <VoiceOrb
                      phase={orbPhase}
                      amplitude={
                  ...
                  <div className="callpilot-stagger-hero flex flex-wrap items-center justify-center gap-2.5">
                    {status === "idle" && (
                      <Button
                        onClick={connect}
                        disabled={consentOpen}
              ...
              <div className="callpilot-stagger-hero mt-7 flex min-h-0 flex-1 flex-col">
